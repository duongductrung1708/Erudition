...
from app.LightRAG.lightrag.prompt import PROMPTS
...
def check_storage_env_vars(storage_name: str) -> None:
    ...
    """
    from app.LightRAG.lightrag.kg import STORAGE_ENV_REQUIREMENTS
...
def tokens_need_and_delta_tokens(chatbot: Chatbot, prompt: str):
    tokens_need = len(encode_string_by_tiktoken(prompt))
    return tokens_need, chatbot.remaining_tokens - tokens_need